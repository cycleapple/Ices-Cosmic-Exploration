...
namespace ICE.Ui
{
    internal class MainWindow : Window
    {
...
#endif
        {
            ...
            TitleBarButtons.Add(new() { ShowTooltip = () => ImGui.SetTooltip("♥ Ko-fi（請我喝杯冰咖啡）"), Icon = FontAwesomeIcon.Heart, IconOffset = new(1, 1), Click = _ => GenericHelpers.ShellStart("https://ko-fi.com/ice643269") });
